...
_cornerActivated:function(a){if(void 0===a.originalEvent)return!1;var a=q?a.originalEvent.touches:[a],b=this.data().f,c=b.parent.offset(),d=this.width(),e=this.height(),a={x:Math.max(0,a[0].pageX-c.left),y:Math.max(0,a[0].pageY-c.top)},b=b.opts.cornerSize,c=i._cAllowed.call(this);if(0>=a.x||0>=a.y||a.x>=d||a.y>=e)return!1;if(a.y<b)a.corner="t";else if(a.y>=e-b)a.corner="b";else a.corner="";if(a.x<=b)a.corner+="l";else if(a.x>=d-b)a.corner+="r";else return!1;if(a.corner==="r")a.corner="tr";if(a.corner==="l")a.corner="tl";return-1==h.inArray(a.corner,c)?!1:a},_c:function(a,
