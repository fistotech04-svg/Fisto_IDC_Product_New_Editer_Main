              ...
              <div className="flex-1 flex flex-col relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[1vw]">
                  {flipbooks.map((book) => {
                    ...
                    const bookImage = book.image ? resolveUploadsPath(book.image) : (book.thumbnail || book.preview || 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&q=80&w=800');
                    return (
