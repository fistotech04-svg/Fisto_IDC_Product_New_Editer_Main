    ...
    >
      ...
      <div className="relative w-full flex-1 flex items-center justify-center min-h-0">
        ...
        >
          ...
          >
            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 bg-[#0095FF] text-white text-[12px] font-semibold px-4 py-1.5 rounded-full shadow-2xl whitespace-nowrap z-20 transform hover:scale-110 transition-transform">
