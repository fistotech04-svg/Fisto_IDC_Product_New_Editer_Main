...
const MagneticSidebarBtn = ({ iconEl, label, onClick, extraStyle = {}, extraClassName = '', mousePos, isTablet, hideTooltip = false }) => {
    ...
    return (
        ...
        >
            ...
            {/* Custom tooltip for side bar (appears right of button) */}
