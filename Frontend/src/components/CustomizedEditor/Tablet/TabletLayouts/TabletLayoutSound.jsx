...
const TabletLayoutSound = ({
    ...
    if (activeLayout != 1 && activeLayout != 2 && activeLayout != 3 && activeLayout != 4 && activeLayout != 5) return null;

    if (isLayout4) {
        return (
            <div
                className="absolute top-[35cqh] left-[7.5cqw] rounded-[0.5cqw] shadow-md flex flex-col pointer-events-auto p-[1cqw] z-50 bg-white border border-gray-200"
                style={{ width: '14cqw' }}
                onClick={(e) => e.stopPropagation()}
            >
                <div className="flex items-center gap-[1cqw] mb-[1.2cqw]">
                    <h2 className="text-[1.3cqw] font-bold text-[#575C9C]">Sound</h2>
                    <div className="flex-1 h-[1px] bg-[#575C9C]/30"></div>
                </div>
                
                {/* Flip Sound Controls */}
                <div className="flex items-center gap-[1.2cqw] mb-[1cqw]">
                    <button
                        className={`flex-shrink-0 w-[2.2cqw] h-[2.2cqw] flex items-center justify-center transition-all bg-[#EAEAF2] hover:bg-[#E0E3F5] rounded-sm ${!flipSoundMasterEnabled && 'opacity-40 cursor-not-allowed'}`}
                        onClick={handleFlipClick}
                        disabled={!flipSoundMasterEnabled}
                    >
                        <Icon icon="mingcute:volume-line" className="w-[1.4cqw] h-[1.4cqw]" style={{ color: '#575C9C' }} />
                    </button>
                    <div className="flex-1 h-[0.3cqw] rounded-full relative cursor-pointer bg-[#575C9C]/20" onPointerDown={(e) => handleVolumeDrag(e, "flip")}>
                        <div className="absolute top-0 left-0 bottom-0 transition-all duration-75 rounded-full bg-[#575C9C]" style={{ width: flipWidth }}>
                            <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-[0.8cqw] h-[0.8cqw] rounded-full shadow-sm bg-[#575C9C]" />
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-[1.2cqw]">
                    <button
                        className={`flex-shrink-0 w-[2.2cqw] h-[2.2cqw] flex items-center justify-center transition-all bg-[#EAEAF2] hover:bg-[#E0E3F5] rounded-sm ${!bgSoundMasterEnabled && 'opacity-40 cursor-not-allowed'}`}
                    ...
                    <div className="flex-1 h-[0.3cqw] rounded-full relative cursor-pointer bg-[#575C9C]/20" onPointerDown={(e) => handleVolumeDrag(e, "bg")}>
                        <div className="absolute top-0 left-0 bottom-0 transition-all duration-75 rounded-full bg-[#575C9C]" style={{ width: bgWidth }}>
                            <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-[0.8cqw] h-[0.8cqw] rounded-full shadow-sm bg-[#575C9C]" />
                        </div>
                    </div>
                </div>
    ...
    if (isLayout3) {
        return (
            <div
                className="absolute top-[6cqw] left-[40cqw] rounded-[1cqw] shadow-[0_1cqw_3cqw_rgba(0,0,0,0.15)] flex flex-col pointer-events-auto p-[1.5cqw] z-50 bg-white border-[1px] border-gray-100"
                style={{ width: '18cqw' }}
                onClick={(e) => e.stopPropagation()}
            >
                <h2 className="text-[1.5cqw] font-bold text-[#4F4A95] mb-[1.5cqw]">Sound</h2>
                ...
                <div className="flex items-center gap-[1.2cqw] mb-[1.5cqw]">
                    <button
                        ...
                        disabled={!flipSoundMasterEnabled}
                    >
                        <Icon icon="mingcute:volume-line" className="w-[1.6cqw] h-[1.6cqw]" style={{ color: '#4F4A95' }} />
                    </button>
                    <div className="flex-1 h-[0.4cqw] rounded-full relative cursor-pointer bg-[#4F4A95]/20" onPointerDown={(e) => handleVolumeDrag(e, "flip")}>
                        <div className="absolute top-0 left-0 bottom-0 transition-all duration-75 rounded-full bg-[#4F4A95]" style={{ width: flipWidth }}>
                            <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-[1cqw] h-[1cqw] rounded-full shadow-sm bg-[#4F4A95]" />
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-[1.2cqw]">
                    ...
                    <div className="flex-1 h-[0.4cqw] rounded-full relative cursor-pointer bg-[#4F4A95]/20" onPointerDown={(e) => handleVolumeDrag(e, "bg")}>
                        <div className="absolute top-0 left-0 bottom-0 transition-all duration-75 rounded-full bg-[#4F4A95]" style={{ width: bgWidth }}>
                            <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-[1cqw] h-[1cqw] rounded-full shadow-sm bg-[#4F4A95]" />
                        </div>
                    </div>
                </div>
    ...
    if (activeLayout == 5) {
        return (
            <div
                className="absolute bottom-[11cqh] left-[41cqw] w-[20cqw] bg-white rounded-[1.2cqw] shadow-[0_1cqw_3cqw_rgba(0,0,0,0.1)] flex flex-col pointer-events-auto p-[2cqw] z-50"
                onClick={(e) => e.stopPropagation()}
            >
                ...
                <div className="flex items-center gap-[1cqw] mb-[1.5cqw]">
                    <h2 className="text-[1.5cqw] font-bold text-[#575C9C]">Sound</h2>
                    <div className="flex-1 h-[1.5px] bg-[#575C9C]"></div>
                </div>
                
                {/* Flip Sound Controls */}
                <div className="flex items-center gap-[1.5cqw] mb-[1.5cqw]">
                    <button
                        className={`flex-shrink-0 w-[3cqw] h-[3cqw] flex items-center justify-center transition-all bg-[#F3F4F8] hover:bg-[#E0E3F5] rounded-full ${!flipSoundMasterEnabled && 'opacity-40 cursor-not-allowed'}`}
                        onClick={handleFlipClick}
                        disabled={!flipSoundMasterEnabled}
                    >
                        <Icon icon="mingcute:volume-line" className="w-[1.6cqw] h-[1.6cqw]" style={{ color: '#575C9C' }} />
                    </button>
                    <div className="flex-1 h-[0.3cqw] rounded-full relative cursor-pointer bg-[#575C9C]/30" onPointerDown={(e) => handleVolumeDrag(e, "flip")}>
                        <div className="absolute top-0 left-0 bottom-0 transition-all duration-75 rounded-full bg-[#575C9C]" style={{ width: flipWidth }}>
                            <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-[1cqw] h-[1cqw] rounded-full shadow-sm bg-[#575C9C]" />
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-[1.5cqw]">
                    <button
                        className={`flex-shrink-0 w-[3cqw] h-[3cqw] flex items-center justify-center transition-all bg-[#F3F4F8] hover:bg-[#E0E3F5] rounded-full ${!bgSoundMasterEnabled && 'opacity-40 cursor-not-allowed'}`}
                        onClick={handleBgClick}
                        disabled={!bgSoundMasterEnabled}
                    >
                        <svg
                    ...
                    <div className="flex-1 h-[0.3cqw] rounded-full relative cursor-pointer bg-[#575C9C]/30" onPointerDown={(e) => handleVolumeDrag(e, "bg")}>
                        <div className="absolute top-0 left-0 bottom-0 transition-all duration-75 rounded-full bg-[#575C9C]" style={{ width: bgWidth }}>
                            <div className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-[1cqw] h-[1cqw] rounded-full shadow-sm bg-[#575C9C]" />
                        </div>
                    </div>
